...
const styles = StyleSheet.create({
  ...
  headerWrap: { paddingHorizontal: 20, paddingTop: 8, paddingBottom: 6 },
  header: { fontSize: 30, fontWeight: "800", color: GREEN },
  scroll: { flex: 1, paddingHorizontal: 14 },
  sectionTitle: {
    color: TEXT, opacity: 0.9, fontSize: 14, marginLeft: 6, marginBottom: 8, marginTop: 12,
  },
  ...
  itemLeft: { flexDirection: "row", flex: 1, alignItems: "center", gap: 12 },
  itemIcon: {
